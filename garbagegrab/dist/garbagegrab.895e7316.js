...
})({"fgrGf":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "15403486895e7316";
"use strict";
...
},{}],"hwtHF":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Game", ()=>Game);
var _three = require("three");
var _gltfloaderJs = require("three/examples/jsm/loaders/GLTFLoader.js");
var _rosieControlsJs = require("./rosieControls.js");
var _sceneManagerJs = require("./sceneManager.js");
...
class Game {
    constructor(container){
        ...
        this.sceneManager = new (0, _sceneManagerJs.SceneManager)(this.scene, this.camera);
        // Connect audio listener to camera after scene manager is created
        if (this.sceneManager.audioListener) this.camera.add(this.sceneManager.audioListener);
        // Initialize UI
        this.ui = new (0, _uiJs.UI)();
        // Initialize GameLogic with wallet from UI
        this.gameLogic = new (0, _gameLogicJs.GameLogic)(this.scene, this.player, this.sceneManager, this.camera, window.backpack);
        // Listen for wallet connection changes
        if (this.ui.connectWalletBtn) this.ui.connectWalletBtn.addEventListener('click', ()=>{
            setTimeout(()=>{
                this.gameLogic.wallet = window.backpack;
                console.log('Updated GameLogic wallet:', this.gameLogic.wallet?.publicKey?.toBase58() || 'No wallet connected');
                // Re-initialize score account after wallet connection
                this.gameLogic.initializeScoreAccount().catch(console.error);
            }, 1000); // Delay to ensure wallet connection completes
        });
        this.gameLogic.init();
        // Start render loop
    ...
    initScene() {
        ...
        this.scene.fog = new _three.Fog(0x000033, 10, 100);
        // Camera
    ...
    loadPlayerModel() {
        try {
            ...
            loader.load('https://play.rosebud.ai/assets/Mech-D5Ww2Jdo42.glb?zjzc', (gltf)=>{
                ...
                model.traverse((child)=>{
                    if (child.isMesh) {
                        ...
                        if (child.material) {
                            child.material.emissive = new _three.Color(0x002244);
                ...
                // Store animations
                this.playerMixer = new _three.AnimationMixer(model);
                this.playerAnimations = {};
                if (gltf.animations && gltf.animations.length > 0) {
                    gltf.animations.forEach((clip)=>{
                        this.playerAnimations[clip.name] = this.playerMixer.clipAction(clip);
                    });
                    if (this.playerAnimations['RobotArmature|Idle']) this.playerAnimations['RobotArmature|Idle'].play();
                }
    ...
    createFallbackPlayer() {
        const geometry = new _three.BoxGeometry(1, 1.5, 1);
    ...
    initControllers() {
        this.playerController = new (0, _rosieControlsJs.PlayerController)(this.player, {
            moveSpeed: 8,
            jumpForce: 0,
            gravity: 0,
            groundLevel: 0.5
        });
        this.cameraController = new (0, _rosieControlsJs.ThirdPersonCameraController)(this.camera, this.player, this.renderer.domElement, {
            distance: 12,
            height: 8,
            rotationSpeed: 0.003
        });
    ...
    start() {
        ...
        // Play startup sound effect and background music
    ...
    animate() {
        ...
        if (this.gameState === 'playing') {
            ...
            if (this.currentTime <= 0) this.endGame();
            // Update controllers
            ...
            if (this.gameLogic.health <= 0) this.endGame();
        }
        this.renderer.render(this.scene, this.camera);
    }
    updatePlayerAnimation() {
        if (!this.playerAnimations || Object.keys(this.playerAnimations).length === 0) return;
        const isMoving = Math.abs(this.playerController.velocity.x) > 0.1 || Math.abs(this.playerController.velocity.z) > 0.1;
        if (isMoving && this.playerAnimations['RobotArmature|Run']) {
            if (!this.currentAnimation || this.currentAnimation !== 'run') this.switchAnimation('run');
        } else if (this.playerAnimations['RobotArmature|Idle']) {
            if (!this.currentAnimation || this.currentAnimation !== 'idle') this.switchAnimation('idle');
        }
    }
...
},{"three":"dsoTF","three/examples/jsm/loaders/GLTFLoader.js":"t3GCp","./rosieControls.js":"8EY8v","./sceneManager.js":"7zBfl","./gameLogic.js":"bCUPQ","./ui.js":"eQTlu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["fgrGf","hwtHF"], "hwtHF", "parcelRequire482b", {})

//# sourceMappingURL=garbagegrab.895e7316.js.map
